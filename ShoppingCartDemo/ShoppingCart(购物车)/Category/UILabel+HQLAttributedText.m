...
- (void)hql_setAttributedTextWithGoodsPrice:(float)price {
    [self hql_setAttributedTextWithGoodsPrice:price smallFontOfSize:14.0f bigFontOfSize:20.0f];
}
...
- (void)hql_setAttributedTextWithGoodsAmount:(NSInteger)amount {
